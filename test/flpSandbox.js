		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#LotManagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LotManagement-display": {
								"semanticObject": "LotManagement",
								"action": "display",
								"description": "Lot Management ",
								"title": "Lot Management ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hirose.mnp.lot.ziemnplot",
									"url": sap.ui.require.toUrl("com/hirose/mnp/lot/ziemnplot")
								}
							}
						}
					}
